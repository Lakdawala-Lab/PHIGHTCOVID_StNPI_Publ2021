...
data[data$DATE=="2020-07-04",]$event_MLER <- "Fourth of July"
...
plot_first_issue <- function(states, window_num, y_axis_max, event_order,
  ...
  p <- ggplot() +
    ...
    scale_color_manual(values=c( "MINNESOTA" = "#66c2A5","TEXAS"= "#FFD92F", "UTAH" = "#FC8D62", "WASHINGTON" = "#E78AC3","CALIFORNIA"= "#99cc66"),
                      name="State")+
    ...
    ylab("Daily Cases per 500,000 People") +
...
states=c( "TEXAS", "UTAH", "WASHINGTON","CALIFORNIA")
...
event_order_name = "Restaurant/Bar Easing"
